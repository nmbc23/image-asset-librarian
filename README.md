...
- Browser gallery with search, saved filter views, clickable source/type breakdowns, local asset tags and notes, active filter chips, detail drawer previous/next navigation, age/orientation/resolution/mark filters, duplicate-only mode, and size/date/name sorting
