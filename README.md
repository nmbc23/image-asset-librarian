...
- Browser gallery with search, saved filter views, inferred theme grouping, clickable source/type/resolution/theme breakdowns, local asset tags and notes, active filter chips, detail drawer previous/next navigation and marking controls, age/orientation/resolution/theme/mark filters, duplicate-only mode, and size/date/name/resolution sorting
